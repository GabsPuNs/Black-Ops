...
namespace BlackOps.Content.Dusts
{
    ...
    {
        public override string Texture => "BlackOps/Content/Dusts/Glow";
        ...
        public override void OnSpawn(Dust dust)
        {
            ...
            dust.shader = new Terraria.Graphics.Shaders.ArmorShaderData(new Ref<Effect>(BlackOps.instance.Assets.Request<Effect>("Effects/GlowingDust", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value), "GlowingDustPass");
            int a = 1;
        }
