...
public class XM177 : ItemOverhaul
{
	public static readonly SoundStyle XM177FireSound = new SoundStyle($"{nameof(BlackOps)}/Assets/Sounds/Items/Guns/AssaultRifles/Car15") {
		Volume = 0.8f,
		PitchVariance = 0.2f,
	};
