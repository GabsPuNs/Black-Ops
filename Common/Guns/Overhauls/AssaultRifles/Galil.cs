...
public class Galil : ItemOverhaul
{
	public static readonly SoundStyle GalilFireSound = new SoundStyle($"{nameof(BlackOps)}/Assets/Sounds/Items/Guns/AssaultRifles/Galil") {
		Volume = 0.5f,
		PitchVariance = 0.2f,
	};
