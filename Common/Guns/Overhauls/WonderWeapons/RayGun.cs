...
public class RayGun : ItemOverhaul
{
	public static readonly SoundStyle RayGunFireSound = new($"{nameof(BlackOps)}/Assets/Sounds/Items/Guns/WonderWeapons/RayGun") {
		Volume = 0.6f,
		PitchVariance = 0.2f,
	};

	public override bool ShouldApplyItemOverhaul(Item item)
		=> item.UseSound == new SoundStyle("BlackOps/Assets/Sounds/Items/Guns/WonderWeapons/RayGun");
