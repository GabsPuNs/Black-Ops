...
public class Glock44 : ItemOverhaul
{
	public static readonly SoundStyle Glock44FireSound = new($"{nameof(BlackOps)}/Assets/Sounds/Items/Guns/Handguns/Glock44") {
		Volume = 0.8f,
		PitchVariance = 0.2f,
	};
	...
	public override void SetDefaults(Item item)
	{
		...
		item.UseSound = Glock44FireSound;
