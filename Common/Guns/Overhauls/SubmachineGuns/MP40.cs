...
public class MP40 : ItemOverhaul
{
	public static readonly SoundStyle MP40FireSound = new SoundStyle($"{nameof(BlackOps)}/Assets/Sounds/Items/Guns/SubmachineGuns/MP40") {
		Volume = 0.8f,
		PitchVariance = 0.2f,
	};
