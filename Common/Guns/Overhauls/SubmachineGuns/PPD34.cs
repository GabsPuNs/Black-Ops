...
public class PPD34 : ItemOverhaul
{
	public static readonly SoundStyle PPD34FireSound = new SoundStyle($"{nameof(BlackOps)}/Assets/Sounds/Items/Guns/SubmachineGuns/PPD34") {
		Volume = 0.8f,
		PitchVariance = 0.2f,
	};
