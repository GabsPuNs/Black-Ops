...
public class Uzi : ItemOverhaul
{
	public static readonly SoundStyle UziFireSound = new SoundStyle($"{nameof(BlackOps)}/Assets/Sounds/Items/Guns/SubmachineGuns/Uzi") {
		Volume = 0.8f,
		PitchVariance = 0.2f,
	};
