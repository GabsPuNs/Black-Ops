...
namespace BlackOps.Common.PlayerLayers
{
                ...
                if (glowTexture != null)
                {
                    ...
                    if (heldItem.useStyle == 5)
                    {
                        if (Item.staff[itemID])
                        {
                            ...
                            int num10 = 0;
                            int num11 = 0;
                            Vector2 origin5 = new Vector2(0f, itemTexture.Height);
                            if (itemID == 3210)
                            {
                            ...
                            drawData = new DrawData(glowTexture, new Vector2((int)(drawInfo.ItemLocation.X - Main.screenPosition.X + origin5.X + (float)num10), (int)(drawInfo.ItemLocation.Y - Main.screenPosition.Y + (float)num11)), sourceRect, new Color(250, 250, 250, heldItem.alpha), num9, origin5, adjustedItemScale, drawInfo.itemEffect, 0);
